    ...
    return(
      <div >     
            ...
            {this.state.items.length > 0 && <div className='column'>
                ...
                <div className='description'>{this.state.items[0].description.substring(0,700) + "..."}</div>
            </div>}
            {this.state.items.length > 1 && <div className='column'>
                ...
                <div className='home_line'><hr id="line"/></div>
                <div className='description'>{this.state.items[1].description.substring(0,700) + "..."}</div>
            </div>}
            {this.state.items.length > 2 && <div className='column'>
                ...
                <div className='home_line'><hr id="line"/></div>
                <div className='description'>{this.state.items[2].description.substring(0,700) + "..."}</div>
            </div>}
            </>

...
function Profile() {
  ...
  //get the experiment the current user enrolled in
  useEffect(() => {
  ...
  try{
    return (
      ...
      <div style={{display:"flex"}}>
        ...
        {/*dispaly the avatar and information depending on user account type*/}
        <div className='left_card'>
          ...
          {/*dispaly the basic information of current user(no difference for organiztion user and student user)*/}
      ...
      {/*display the introduction about the organization (For organization user only)*/}
      ...
      {/*show a list of experiment which enrolled by the current user with a "Cancel" button in each experiment for user to cancel enrollment*/}
...
//Hide the content of the profile according to user account type
function Hide(){
    const [items, setItems] = useState([{}]);
  ...
  useEffect(() => {
    ...
    //hide content accroding to the account type
    try{
